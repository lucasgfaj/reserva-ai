import { IsString, IsOptional, IsNumber, IsBoolean, MaxLength, Min, Max, Matches } from 'class-validator';
import { ApiProperty, ApiPropertyOptional } from '@nestjs/swagger';

export class UpdateCommonAreaDto {
  @ApiPropertyOptional({ example: 'Salão de Festas Premium', description: 'Nome da área comum (2-120 caracteres)' })
  @IsOptional()
  ...
  @ApiPropertyOptional({ example: 100, description: 'Capacidade máxima (0-10000)' })
  @IsOptional()
  ...
  @ApiPropertyOptional({ example: '09:00', description: 'Horário de abertura (HH:MM)' })
  @IsOptional()
  ...
  @ApiPropertyOptional({ example: '23:00', description: 'Horário de fechamento (HH:MM)' })
  @IsOptional()
