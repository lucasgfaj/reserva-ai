    ...
    <main :class="['flex-1 flex flex-col min-h-screen w-full transition-all duration-300', sidebarCollapsed ? 'md:ml-16' : 'md:ml-72']">
      ...
      <div class="flex-1 p-4 md:p-6 lg:p-8 flex flex-col items-center justify-center text-center">
        <div class="w-20 h-20 bg-amber-100 rounded-full flex items-center justify-center mb-6">
          <span class="material-symbols-outlined text-4xl text-amber-500">assessment</span>
        </div>
        <h1 class="text-2xl font-bold text-cyan-900 mb-2">Relatórios</h1>
        <p class="text-slate-500 max-w-md mb-2">Esta será uma funcionalidade futura para geração de relatórios do condomínio.</p>
        <span class="inline-flex items-center gap-1 px-3 py-1 bg-amber-50 text-amber-700 rounded-full text-sm font-medium">Possível feature - Relatórios de ocupação e uso</span>
      </div>
    </main>
